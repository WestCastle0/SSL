...
SSMatrix4 SSFramework::SSMatrix4::operator/(float f) const
{
	float inv = 1.0f / f;
	SSMatrix4 n;
...
SSMatrix4 SSFramework::operator*(float f, const SSMatrix4& m)
{
	...
	n.val[0x9] = m.val[0x9] * f;
	n.val[0xa] = m.val[0xa] * f;
	n.val[0xb] = m.val[0xb] * f;
	n.val[0xc] = m.val[0xc] * f;
	n.val[0xd] = m.val[0xd] * f;
	n.val[0xe] = m.val[0xe] * f;
	n.val[0xf] = m.val[0xf] * f;
	return n;
}
...
SSMatrix4 SSFramework::operator/(float f, const SSMatrix4& m)
{
	...
	n.val[0x9] = m.val[0x9] * inv;
	n.val[0xa] = m.val[0xa] * inv;
	n.val[0xb] = m.val[0xb] * inv;
	n.val[0xc] = m.val[0xc] * inv;
	n.val[0xd] = m.val[0xd] * inv;
	n.val[0xe] = m.val[0xe] * inv;
	n.val[0xf] = m.val[0xf] * inv;
	return n;
}
